 ...
 */ (function (E, A) {
        ...
        c = function () {
            ...
            b.extend({
                ...
                merge: function (i, r) {
                    var y = i.length,
                        z = 0;
                    if (typeof r.length === "number") for (var F = r.length; z < F; z++) i[y++] = r[z];
        ...
        data: function (a, b, d) {
            if (c.acceptData(a)) {
                ...
                if (!(e && !f && typeof b === "string" && d === A)) {
                    ...
                    else h = a; if (typeof b === "object") if (e) h[f] =
                                c.extend(h[f], b);
                        else c.extend(h, b);
                        else if (e && !h[f]) h[f] = {};
                    a = e ? h[f] : h;
            ...
            if (!(a.nodeType === 3 || a.nodeType === 8)) {
                ...
                if (h = c.data(a)) {
                    ...
                    for (var s = 0, v; k = b[s++];) {
                        ...
                        if (!B) {
                            B = l[k] = [];
                            if (!D.setup || D.setup.call(a, e, v, n) === false) if (a.addEventListener) a.addEventListener(k, n, false);
    ...
    (function () {
        ...
        var l = function (g, j, o, m) {
            ...
            if (q.length > 1 && s.exec(g)) if (q.length === 2 && n.relative[q[0]]) x = M(q[0] + q[1], j);
                else for (x = n.relative[q[0]] ? [j] : l(q.shift(), j); q.length;) {
                        g = q.shift();
            ...
            if (f.call(C) === "[object Array]") if (N) if (j && j.nodeType === 1) for (g = 0; C[g] != null; g++) {
                    ...
                    } else for (g = 0; C[g] != null; g++) C[g] && C[g].nodeType === 1 && o.push(x[g]);
        ...
        var n = l.selectors = {
            ...
            preFilter: {
                CLASS: function (g, j, o, m, p, q) {
                    ...
                    q = 0;
                    for (var t;
                    (t = j[q]) != null; q++) if (t) if (p ^ (t.className && (" " + t.className + " ").replace(/[\t\n]/g, " ").indexOf(g) >= 0)) o || m.push(t);
                            else if (o) j[q] = false;
                    return false
                },
                ID: function (g) {
                ...
                PSEUDO: function (g, j, o, m, p) {
                    if (g[1] === "not") if ((d.exec(g[3]) || "").length > 1 || /^\w/.test(g[3])) g[3] = l(g[3], null, null, j);
                        else {
        ...
        try {
            ...
            D = function (g, j) {
                ...
                if (f.call(g) === "[object Array]") Array.prototype.push.apply(o,
                        g);
                else if (typeof g.length === "number") for (var p = g.length; m < p; m++) o.push(g[m]);
    ...
    c.extend({
        ...
        cleanData: function (a) {
            ...
            (l = a[k]) != null; k++) if (!(l.nodeName && c.noData[l.nodeName.toLowerCase()])) if (d = l[c.expando]) {
